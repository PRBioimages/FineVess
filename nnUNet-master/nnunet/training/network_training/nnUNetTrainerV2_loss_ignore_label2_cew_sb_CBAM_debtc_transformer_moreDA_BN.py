from nnunet.training.network_training.nnUNetTrainerV2_loss_ignore_label2_ce_w_sb import nnUNetTrainerV2_loss_ignore_label2_ce_w_sb
...
class nnUNetTrainerV2_loss_ignore_label2_cew_sb_CBAM_debtc_transformer_moreDA_BN(nnUNetTrainerV2_loss_ignore_label2_ce_w_sb): # BL + SE
    ...
    def initialize_network(self):
        ...
        self.network = Generic_UNet(self.num_input_channels, self.base_num_features, self.num_classes,
                                    ...
                                    ifCBAM_decoder_before_tc=True,iftransformer=True,iftransformer_encoder=True)
