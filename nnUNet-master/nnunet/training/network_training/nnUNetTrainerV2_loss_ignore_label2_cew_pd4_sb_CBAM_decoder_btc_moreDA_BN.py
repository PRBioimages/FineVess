from nnunet.training.network_training.nnUNetTrainerV2_loss_ignore_label2_ce_w_pd_sb import nnUNetTrainerV2_loss_ignore_label2_ce_w_pd_sb
...
class nnUNetTrainerV2_loss_ignore_label2_cew_pd4_sb_CBAM_decoder_btc_moreDA_BN(nnUNetTrainerV2_loss_ignore_label2_ce_w_pd_sb): # BL + SE
