...
class nnUNetTrainerV2_loss_ignore_label2_cew_sb_scSE_moreDA_BN(nnUNetTrainerV2_loss_ignore_label2_ce_w_sb):
    ...
    def initialize_network(self):
        ...
        self.network = Generic_UNet(self.num_input_channels, self.base_num_features, self.num_classes,
                                    ...
                                    ifCBAM_decoder_before_tc=False,ifscSE_de=True)
        # print(self.network)
